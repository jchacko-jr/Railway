...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2023 at 05:16 PM
...
(1, 'System ', 'Admin', 'admin@mail.com', 'Administrator', '4028a0e356acc947fcd2bfbf00cef11e128d484a', 'admin-icn.png');

-- --------------------------------------------------------

--
-- Table structure for table `orrs_contact`
--

CREATE TABLE `orrs_contact` (
...
--
-- Dumping data for table `orrs_contact`
--

INSERT INTO `orrs_contact` (`f_name`, `l_name`, `email`, `number`, `message`) VALUES
('jomon', 'chacko', 'jomunchacko@gma', 2147483647, 'hey happpy to help'),
('jomon', 'chacko', 'jomunchacko@gma', 2147483647, 'hey happpy to help'),
('jomon', 'chacko', 'jomunchacko@gma', 2147483647, 'hey happpy to help'),
('jomon', 'chacko', 'jomunchacko@gma', 2147483647, 'jfgfhdfdh'),
('jomon', 'chacko', 'jomunchacko@gma', 2147483647, 'data is inserted'),
('jomon', 'chacko', 'jomunchacko@gma', 2147483647, 'data is inserted'),
('jomon', 'chacko', 'jochacko47@gmai', 2147483647, 'Test47'),
('jomon', 'chacko', 'jomunchacko@gma', 2147483647, 'testonceisverfied');
...
(4747, 'jomon', 'jomon', '745', '789456123', '123 street chry', 'jomon123', 'test123@gmail.com', '4028a0e356acc947fcd2bfbf00cef11e128d484a', 'New Project.png', '785');
...
(22, 'Jomon', '', '', '', '', '67a74306b06d0c01624fe0d0249a570f4d093747', '', '', '', '', '', '', '', '', '', '', ''),
(23, 'Jomon', '', '', '', '', '67a74306b06d0c01624fe0d0249a570f4d093747', '', '', '', '', '', '', '', '', '', '', ''),
(24, 'qqqq', 'wwww', 'wwww', 'wwww', 'sss@gamail.com', '268342a1a7c8dc64a8ad545c495ffe683ed473c8', '', 'www', '', '', '', '', '', '', '', '', ''),
(29, 'jowe', 'eee', 'eee', 'eee', 'eee@gmail.com', '42d6d602e487078edc5756bc17d3a19ed176e0a1', '', 'eee', '', '', '', '', '', '', '', '', ''),
(30, 'test', 'test', '789456123', 'puthentpurackal', 'test@gmail.com', '4028a0e356acc947fcd2bfbf00cef11e128d484a', 'New_Project-removebg-preview.png', 'jo47__', '', '', '', '', '', '', '', '', ''),
(31, 'test12', 'test12', '78451245', 'testtts', 'test@47.in.com', '4028a0e356acc947fcd2bfbf00cef11e128d484a', '', 'test@47', '', '', '', '', '', '', '', '', ''),
(32, 'server', 'test', '741258963', 'server', 'test@server.com', '4028a0e356acc947fcd2bfbf00cef11e128d484a', 'favicon.ico', 'test@server', '', '', '16305', 'Venad Express', 'TRIVANDRUM', '5.00AM', 'ERNAKULAM', '60', 'INR');
...
CREATE TABLE `orrs_train` (
  ...
  `fare_payment_code` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `orrs_train` (`id`, `name`, `route`, `current`, `destination`, `time`, `passengers`, `number`, `fare`, `fare_payment_code`) VALUES
(6, 'Venad Express', 'TRIVANDRUM _ERNAKULAM', 'TRIVANDRUM', 'ERNAKULAM', '5.00AM', '200', '16305', '60', NULL),
(10, 'ZX Express', 'Location One - Location Two', 'Test Station', 'Test Demo Station', '7:00 PM', '200', 'CA556680', '65', NULL),
(11, 'Iron Range Express', 'Stockton - San Diego', 'Stockton', 'San Diego', '9:00 AM', '185', 'CA-697', '43', NULL),
(12, 'Colonial', 'Boston - New York', 'Boston', 'New York', '10:45 AM', '255', 'CA-107', '35', NULL),
(13, 'Corridor Express', 'New York - Washington', 'New York', 'Washington', '1:00 PM', '330', 'CA-777', '38', NULL),
(14, 'Silver Meteor', 'New York - Miami', 'New York', 'Miami', '10:00 AM', '200', 'CA-707', '128', NULL),
(15, 'Silver Star', 'New Orleans - Los Angeles', 'New Orleans', 'Los Angeles', '8:45 AM', '190', 'CA-107', '149', NULL),
(16, 'Adirondack', 'Seattle - New York', 'Seattle', 'New York', '6:00 AM', '210', 'CA-778', '198', NULL),
(17, 'Corridor Express', 'New York - Pittsfield', 'New York', 'Pittsfield', '12:45 PM', '195', 'CA-797', '45', NULL);
...
(10, 'server test', 'test@server.com', 'server', 'Venad Express', '16305', 'TRIVANDRUM', 'ERNAKULAM', '60', 'INR', '');
...
--
ALTER TABLE `orrs_employee`
  MODIFY `emp_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4748;

--
-- AUTO_INCREMENT for table `orrs_passenger`
--
ALTER TABLE `orrs_passenger`
  MODIFY `pass_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

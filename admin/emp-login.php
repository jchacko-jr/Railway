      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
            ...
            <div class="card-header"><img class="logo-img" src="assets/img/TRK.png" alt="logo" width="{conf.logoWidth}" height="50">
              <span class="splash-description">Admin Login Panel</span></div>
              <div class="card-body">
